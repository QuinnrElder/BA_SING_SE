...
describe("ManagerPage", () => {
  it("Should display ManagerPage Elements", () => {
    ...
    let managerContainer = document.getElementById('managerContainer')
    let mainFormWrapper = document.getElementById('main-form-wrapper')
    expect(managerContainer).toBeInTheDocument();
    expect(mainFormWrapper).toBeInTheDocument();
  })
})
